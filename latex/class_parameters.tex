...
Active oÃ¹ dÃ©sactive l\textquotesingle{}importation des paramÃ¨tres lors de l\textquotesingle{}importation du fichier texte. 
...
Active ou dÃ©sactive la gÃ©nÃ©ration limite. 
...
Active ou dÃ©sactive le bouton permettant de gÃ©nÃ©rer un nombre alÃ©atoire de cellule. 
...
Le nombre d\textquotesingle{}Ã©lÃ©ments ayant pour valeur 1. 
...
Permet d\textquotesingle{}envoyer les parametres aux diffÃ©rents outils. 
...
RÃ©cupÃ¨re la valeur entrÃ©e dans inputfield\+Max\+Gen. 
...
RÃ©cupÃ©re la rÃ¨gle de voisinage sÃ©lectionnÃ© et rend l\textquotesingle{}interaction impossible avec les boutons en consÃ©quence. 
...
Boutons du panel dÃ©tection lors de l\textquotesingle{}activation de la dÃ©tection automatique. 
...
true si la dÃ©tection des canons est activÃ©e, false sinon. 
...
Contient le dropdown des rÃ¨gles de voisinage. 
...
Stocke l\textquotesingle{}instance pour l\textquotesingle{}Ã©diteur de structure. 
...
Zone de texte pour la gÃ©nÃ©ration maximale. 
...
Zone de text pour la pÃ©riode maximale. 
...
true s\textquotesingle{}il y a un nombre maximal de gÃ©nÃ©rations, false sinon. 
...
Nombre de rÃ¨gles de naissances et de survie. 
...
true si un nombre alÃ©atoire de cellule est choisi, false sinon. 
...
Tableau contenant les rÃ¨gles de naissances choisies. 
...
Contient les rÃ¨gles de voisinages. 
...
Tableau contenant les rÃ¨gles de survies choisies. 
...
Variable contenant le toggle pour les dÃ©pendances. 
...
Variable contenant le toggle pour savoir si l\textquotesingle{}import, import les paramÃ¨tres Ã©galement. 
