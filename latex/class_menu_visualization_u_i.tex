...
Active le panel save et bloque la camÃ©ra si clic sur le bouton. 
...
Active oÃ¹ dÃ©sactive la visualisation des cellules. 
...
true si la souris est activÃ©e, false sinon. 
...
Zone ou la souris peut etre dÃ©tectÃ©e. 
...
Le panel pour afficher les informations d\textquotesingle{}aide Ã  l\textquotesingle{}utilisateur. 
...
Bouton cocheable pour activer ou dÃ©sactiver la visualisation. 
...
Le slider associÃ© Ã  la vitesse de simulation. 
...
Le texte du bouton Play qui peut Ãªtre \char`\"{}\+Play\char`\"{} ou \char`\"{}\+Pause\char`\"{} 
